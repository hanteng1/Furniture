		...
		if ( this.activeLook ) {
			...
			switch ( event.button ) {
				...
				case 0: 
					...
					this.mouseDragStartX = event.pageX;
					this.mouseDragStartY = event.pageY;
				break;
	...
	this.onMouseMove = function ( event ) {
		...
		if ( this.domElement === document ) {
			...
			if(this.mouseDragOn) {
				...
				this.mouseX = this.mouseDragStartX - event.pageX;
				this.mouseY = this.mouseDragStartY - event.pageY ;
