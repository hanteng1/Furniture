		...
		function onPointerMove( event ) {
			...
			if ( _mode === "translate" ) {
				...
				if ( scope.space === "world" || scope.axis.search( "XYZ" ) !== - 1 ) {
					...
					//trigger furniture position update event
					var updatedWorldPosition = new THREE.Vector3();
					updatedWorldPosition.setFromMatrixPosition( scope.object.matrixWorld );
					scope.furniture.updatePosition(updatedWorldPosition);
